...
// Если приведения будучи замедленными (Зелёными сожрут пекмена) То фиолетовое приведение (возможно и любое друго в зависимости от ситуации не сожет выдти из домика) (Скорее всего слишком рано переключившись
// из режима выхода из домика в обычный режим)
